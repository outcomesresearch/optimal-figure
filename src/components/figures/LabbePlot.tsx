...
const Component = () => {
  return (
    <TabLayout
      description="The L’Abbe Plot is a graphical method used in meta-analysis to compare the event rates between two groups. It helps in identifying patterns and potential outliers in the data."
      tabsConfiguration={[
        {
          key: "characteristics",
