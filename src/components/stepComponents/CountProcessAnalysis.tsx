  ...
  return (
    <>
      ...
      <Text>
        ...
        various factors contribute to the frequency or rate of events taking
        place. This method considers multiple independent variables and
        determines their association with the occurrence and timing of the
        event. Given the complexity of Count Process Analysis, it is advisable
        to seek assistance from a qualified statistician.
      </Text>
    </>
  );
};
